...
(function (global, factory) {
    ...
    let Identifiers$3 = class Identifiers{
        constructor(){
            this.TK_INT = 'INT';
            this.TK_FLOAT = 'FLOAT';
    ...
    let String_$1 = class String_ extends Value$2{
    ...
    let Number_$3 = class Number_ extends Value$1{
        constructor(value){
            super();
            this.value = value;
        }
    ...
    let Boolean_$1 = class Boolean_ extends Number_$2{
    ...
    let Tokenization$1 = class Tokenization {
    ...
    let Parser$1 = class Parser{
        ...
        while_expr(){
            ...
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'while')) {
                return res.failure(new e$2.InvalidSyntaxError(
                    this.current_token.pos_start,
                    this.current_token.pos_end,
                    "Expected 'while'",
            ...
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'do')) {
                return res.failure(new e$2.InvalidSyntaxError(
                    this.current_token.pos_start,
                    this.current_token.pos_end,
                    "Expected 'do'",
            ...
            if (this.current_token.type == It$1.TK_NEWLINE) {
                ...
                if (!this.current_token.matches(It$1.TK_KEYWORD, 'endwhile')) {
                    return res.failure(new e$2.InvalidSyntaxError(
                        this.current_token.pos_start,
                        this.current_token.pos_end,
                        "Expected 'endwhile'",
        ...
        func_expr(){
            ...
            const res = new Result();
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'function')) {
                return res.failure(new e$2.InvalidSyntaxError(
                    this.current_token.pos_start,
                    this.current_token.pos_end,
                    "Expected 'function'",
            ...
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'endfunction')) {
                return res.failure(new e$2.InvalidSyntaxError(
                    this.current_token.pos_start,
                    this.current_token.pos_end,
        ...
        for_expr(){
            ...
            const res = new Result();
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'for')) {
                return res.failure(new e$2.InvalidSyntaxError(
                    this.current_token.pos_start,
                    this.current_token.pos_end,
                    "Expected 'for'",
            ...
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'to')) {
                return res.failure(new e$2.InvalidSyntaxError(
                    this.current_token.pos_start,
                    this.current_token.pos_end,
                    "Expected 'to'",
            ...
            if (this.current_token.matches(It$1.TK_KEYWORD,'step')) {
            ...
            if (this.current_token.type == It$1.TK_NEWLINE) {
                ...
                if (!this.current_token.matches(It$1.TK_KEYWORD, 'endfor')) {
                    return res.failure(new e$2.InvalidSyntaxError(
                        this.current_token.pos_start,
                        this.current_token.pos_end,
                        "Expected 'endfor'",
        ...
        if_expr_c(){
            ...
            if (this.current_token.matches(It$1.TK_KEYWORD,'else')) {
                res.register_next();
                this.next();
                ...
                if (this.current_token.type == It$1.TK_NEWLINE) {
                    ...
                    if (this.current_token.matches(It$1.TK_KEYWORD,'endif')) {
        ...
        if_expr_b_or_c(){
            ...
            if (this.current_token.matches(It$1.TK_KEYWORD,'else')
                &&
                this.tmp_next_token().matches(It$1.TK_KEYWORD,'if')
                ) {
        ...
        if_expr_cases(case_keyword, is_elif=null){
            ...
            if (!this.current_token.matches(It$1.TK_KEYWORD, 'then')) {
        ...
        atom(who_call){
            ...
            else if (token.matches(It$1.TK_KEYWORD,'if')) {
            ...
            else if (token.matches(It$1.TK_KEYWORD,'for')) {
            ...
            else if (token.matches(It$1.TK_KEYWORD,'while')) {
            ...
            else if (token.matches(It$1.TK_KEYWORD,'function')) {
        ...
        compare_expr(){
            ...
            const res = new Result();
            if (this.current_token.matches(It$1.TK_KEYWORD, 'not')) {
        ...
        statement(){
            ...
            if (this.current_token.matches(It$1.TK_KEYWORD, 'return')) {
                res.register_next();
                this.next();
            ...
            if (this.current_token.matches(It$1.TK_KEYWORD, 'continue')) {
                res.register_next();
                this.next();
            ...
            if (this.current_token.matches(It$1.TK_KEYWORD, 'break')) {
                res.register_next();
                this.next();
    ...
    let List$2 = class List extends Value{
    ...
    let FunctionBase$2 = class FunctionBase extends Value_{
        constructor(name){
            super();
            ...
            if (args.length != arg_names.length) {
                return res.failure(
                    new e$1.RunTimeError(
                        this.pos_start,
                        this.pos_end,
                        `Expected ${arg_names.length} arguments but got ${args.length}`,
                        this.context
                    )
                );
            }
    ...
    let Function_$1 = class Function_ extends FunctionBase$1{
    ...
    let Interpreter$1 = class Interpreter{
        ...
        run_BinaryOperationNode(node, context){
            ...
            else if (node.op_token.matches(It.TK_KEYWORD, 'and')) {
                var result = left.and_by(right);
            }
            else if (node.op_token.matches(It.TK_KEYWORD, 'or')) {
        ...
        run_UnaryOperationNode(node, context){
            ...
            else if (node.op_token.matches(It.TK_KEYWORD,'not')) {
    ...
    function failed_params_count(expected,args_len, node){
      ...
      return res.failure(
        new e.RunTimeError(
            ...
            `Function expected ${expected} argument/s, currently there is ${args_len}`,
    ...
    let BuiltIn$1 = class BuiltIn extends FunctionBase{
        constructor(name){
            super(name);
        }
        execute(args){
        ...
        execute_length(exec_ctx){
          ...
          return res.failure(
            new e.RunTimeError(
                node.pos_start,
                node.pos_end,
                'The argument must be a list or a string',
                node
            )
          )
          ...
          if(
            ...
            return res.failure(
              new e.RunTimeError(
                  ...
                  `Index '${parseInt(node2.value)}' is out of range`,
                  node2
              )
            )
          }
          ...
          if (!((node1 instanceof String_) || (node1 instanceof Number_))) {
            return res.failure(
              new e.RunTimeError(
                  node1.pos_start,
                  node1.pos_end,
                  'The argument must be a string or a number',
                  node1
              )
            )
          }
